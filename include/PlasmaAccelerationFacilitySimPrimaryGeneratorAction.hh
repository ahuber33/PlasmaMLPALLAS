/// PlasmaAccelerationFacilitySimPrimaryGeneratorAction.hh
//// Auteur: Arnaud HUBER for ENL group <huber@lp2ib.in2p3.fr>
//// Copyright: 2024 (C) Projet PALLAS

#ifndef PlasmaAccelerationFacilitySimPrimaryGeneratorAction_h
#define PlasmaAccelerationFacilitySimPrimaryGeneratorAction_h 1
...
class PlasmaAccelerationFacilitySimPrimaryGeneratorAction : public G4VUserPrimaryGeneratorAction
{
public:
  PlasmaAccelerationFacilitySimPrimaryGeneratorAction(size_t, size_t, bool);
  ~PlasmaAccelerationFacilitySimPrimaryGeneratorAction();
