/// PlasmaAccelerationFacilitySimRunAction.hh
//// Auteur: Arnaud HUBER for ENL group <huber@lp2ib.in2p3.fr>
//// Copyright: 2024 (C) Projet PALLAS

#ifndef PlasmaAccelerationFacilitySimRunAction_h
#define PlasmaAccelerationFacilitySimRunAction_h 1
...
class PlasmaAccelerationFacilitySimRunAction : public G4UserRunAction
{

public:
  PlasmaAccelerationFacilitySimRunAction(const char*, G4bool);
  ~PlasmaAccelerationFacilitySimRunAction();
...
public:
  ...
  void SetPrimaryGenerator(PlasmaAccelerationFacilitySimPrimaryGeneratorAction* gen);
  void SetGeometry(PlasmaAccelerationFacilitySimGeometryConstruction* geom);
...
private:
  ...
  protected:
  PlasmaAccelerationFacilitySimPrimaryGeneratorAction* fPrimaryGenerator = nullptr;
  PlasmaAccelerationFacilitySimGeometryConstruction* fGeometry = nullptr;
