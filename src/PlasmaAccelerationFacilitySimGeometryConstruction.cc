//// PlasmaAccelerationFacilitySimGeometryConstruction.cc
...
G4ThreadLocal PlasmaAccelerationFacilitySimMagneticField *PlasmaAccelerationFacilitySimGeometryConstruction::fMagneticField = nullptr;
G4ThreadLocal G4FieldManager *PlasmaAccelerationFacilitySimGeometryConstruction::fFieldMgr =
    nullptr;

// Constructor
PlasmaAccelerationFacilitySimGeometryConstruction::PlasmaAccelerationFacilitySimGeometryConstruction()
...
void PlasmaAccelerationFacilitySimGeometryConstruction::SetLogicalVolumeColor(
...
void PlasmaAccelerationFacilitySimGeometryConstruction::CreateWorldAndHolder()
{
...
void PlasmaAccelerationFacilitySimGeometryConstruction::ConstructQuadrupoleVolume()
{
...
void PlasmaAccelerationFacilitySimGeometryConstruction::ConstructCellulePart()
{
    auto Inox =
...
void PlasmaAccelerationFacilitySimGeometryConstruction::ConstructLIFPart()
{
    auto Inox =
        G4NistManager::Instance()->FindOrBuildMaterial("G4_STAINLESS-STEEL");
...
void PlasmaAccelerationFacilitySimGeometryConstruction::ConstructSection1Part()
{
    auto Inox =
        G4NistManager::Instance()->FindOrBuildMaterial("G4_STAINLESS-STEEL");
...
void PlasmaAccelerationFacilitySimGeometryConstruction::ConstructSection2Part()
{
    auto Inox =
        G4NistManager::Instance()->FindOrBuildMaterial("G4_STAINLESS-STEEL");
...
void PlasmaAccelerationFacilitySimGeometryConstruction::ConstructSection3Part()
{
...
void PlasmaAccelerationFacilitySimGeometryConstruction::ConstructSection4Part()
{
...
void PlasmaAccelerationFacilitySimGeometryConstruction::ConstructCollimators()
{
    auto Inox = G4NistManager::Instance()->FindOrBuildMaterial("G4_STAINLESS-STEEL");
...
void PlasmaAccelerationFacilitySimGeometryConstruction::ConstructSection4DumpPart()
{
...
void PlasmaAccelerationFacilitySimGeometryConstruction::ConstructSDandField()
{
    // magnetic field ----------------------------------------------------------
    fMagneticField = new PlasmaAccelerationFacilitySimMagneticField();
...
G4VPhysicalVolume *PlasmaAccelerationFacilitySimGeometryConstruction::Construct()
{
