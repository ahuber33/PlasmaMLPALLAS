//// PlasmaAccelerationFacilitySimMagneticfield.cc
...
PlasmaAccelerationFacilitySimMagneticField::PlasmaAccelerationFacilitySimMagneticField() {}
PlasmaAccelerationFacilitySimMagneticField::~PlasmaAccelerationFacilitySimMagneticField() {}
...
void PlasmaAccelerationFacilitySimMagneticField::GetFieldValue(const G4double point[4], G4double *bField) const
{
    G4double x = point[0];
    G4double y = point[1];
    G4double z = point[2];
...
void PlasmaAccelerationFacilitySimMagneticField::SetDipoleField(G4double fieldValue)
{
    ConstantDipoleBField = fieldValue;
}

void PlasmaAccelerationFacilitySimMagneticField::SetMapBFieldStatus(G4bool status)
{
    StatusMapBField = status;
}

void PlasmaAccelerationFacilitySimMagneticField::SetGradient(size_t index, G4double gradient)
{
...
G4double PlasmaAccelerationFacilitySimMagneticField::GetGradient(size_t index) const
{
    if (index < NumQuadrupoles)
...
void PlasmaAccelerationFacilitySimMagneticField::SetQLength(size_t index, G4double length)
{
    if (index < NumQuadrupoles)
    {
...
G4double PlasmaAccelerationFacilitySimMagneticField::GetQLength(size_t index) const
{
    if (index < NumQuadrupoles)
...
void PlasmaAccelerationFacilitySimMagneticField::SetQDrift(size_t index, G4double drift)
{
    if (index < NumQuadrupoles)
    {
        qdrift[index] = drift;
...
G4double PlasmaAccelerationFacilitySimMagneticField::GetQDrift(size_t index) const
{
    if (index < NumQuadrupoles)
        return qdrift[index];
    else
