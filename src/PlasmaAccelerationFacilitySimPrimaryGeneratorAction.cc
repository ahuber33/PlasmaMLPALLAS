/// PlasmaAccelerationFacilitySimPrimaryGeneratorAction.cc
...
PlasmaAccelerationFacilitySimPrimaryGeneratorAction::PlasmaAccelerationFacilitySimPrimaryGeneratorAction(size_t N, size_t numThreads, G4bool pMT)
    : NEventsGenerated(N),
...
PlasmaAccelerationFacilitySimPrimaryGeneratorAction::~PlasmaAccelerationFacilitySimPrimaryGeneratorAction()
{
  delete particleGun;
...
void PlasmaAccelerationFacilitySimPrimaryGeneratorAction::SetParticleName()
{
...
void PlasmaAccelerationFacilitySimPrimaryGeneratorAction::ShowProgress(double progress, std::chrono::high_resolution_clock::time_point startTime)
{
...
void PlasmaAccelerationFacilitySimPrimaryGeneratorAction::CalculProgress()
{
  if (flag_MT == true)
  {
...
void PlasmaAccelerationFacilitySimPrimaryGeneratorAction::GeneratePrimaries(G4Event *anEvent)
{
